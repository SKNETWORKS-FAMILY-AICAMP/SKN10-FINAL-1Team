...
def summarize_node(state: State):
    ...
    if document_type == "proceedings" : 
        order = (
            ...
            "second, the key discussion points, "
            "and third, the decisions made, "
        ...
        order = (
            ...
            f"summarize the answer to \"{user_input}\" in no more than 1500 characters. Respond in Korean."
        )
        ...
        order = (
            "You are a text assistant. Respond in Korean. No matter what text you receive, just respond with this message. 'I could not determine the type of document you requested... sorry.'"
        )
    ...
    # Return the full state dictionary to support both direct and message-based modes
    return state.dict()
